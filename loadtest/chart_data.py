...
def build_matrix_chart_data(results_matrix: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    for item in results_matrix:
        ...
        points.append({
            ...
            "total_requests": res.get("total_requests"),
            "successful_requests": res.get("successful_requests"),
            "failed_requests": res.get("failed_requests"),
            "rpm": res.get("rpm"),
            "qps": res.get("qps"),
            "input_tpm": res.get("input_tpm"),
            "output_tpm": res.get("output_tpm"),
            "total_tpm": res.get("total_tpm"),
            "input_tps": res.get("input_tps"),
            "output_tps": res.get("output_tps"),
            ...
            "latency_p90": res.get("latency_sec_p90"),
            ...
            "ttft_p90": res.get("ttft_sec_p90"),
            "ttft_p95": res.get("ttft_sec_p95"),
            "ttft_p99": res.get("ttft_sec_p99"),
            "decode_avg": res.get("decode_sec_avg"),
            "decode_p50": res.get("decode_sec_p50"),
            "decode_p90": res.get("decode_sec_p90"),
            "decode_p95": res.get("decode_sec_p95"),
            "decode_p99": res.get("decode_sec_p99"),
        })
