...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--base-url", required=True, help="https://api.wenwen-ai.com/v1")
    parser.add_argument("--api-key", required=True, help="sk-G5JY02Ovu0HN6aEXc8wXfObOL7qVT30ulzNJewmVrwdDtovD")
    parser.add_argument("--model", required=True, help="glm-5.1")
