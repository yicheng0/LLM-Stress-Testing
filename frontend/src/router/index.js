...
const routes = [
  ...
  { path: '/tests/kimi-suite', name: 'kimi-suite', component: () => import('../views/KimiSuite.vue') },
  { path: '/tests/kimi-suite/:id', name: 'kimi-suite-result', component: () => import('../views/KimiSuiteResult.vue'), props: true },
  { path: '/tests/vendor-billing', name: 'vendor-billing', component: () => import('../views/VendorBillingSelfTest.vue') },
  { path: '/vendor-templates', name: 'vendor-templates', component: () => import('../views/VendorTemplates.vue') },
  { path: '/vendor-templates/new', name: 'vendor-template-new', component: () => import('../views/VendorTemplateForm.vue') },
  { path: '/vendor-templates/:id/edit', name: 'vendor-template-edit', component: () => import('../views/VendorTemplateForm.vue'), props: true },
  { path: '/tests/vendor-billing/:id/run', name: 'vendor-billing-run', component: () => import('../views/VendorBillingRun.vue'), props: true },
  { path: '/tests/vendor-billing/:id/result', name: 'vendor-billing-result', component: () => import('../views/VendorBillingResult.vue'), props: true },
